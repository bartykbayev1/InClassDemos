      ...
      <div class="col-md-7">
        <details open>
            ...
            <asp:GridView ID="SeatingGridView" runat="server" AutoGenerateColumns="False"
                    ...
                    DataSourceID="SeatingObjectDataSource" ItemType="eRestaurantSystem.Entities.POCO.SittingSummary">
                <Columns>
    ...
    <div class="pull-right col-md-5">      
        <details open>                  
            ...
            <asp:ObjectDataSource runat="server" 
                ...
                TypeName="eRestaurant.BLL.AdminController">            
                <SelectParameters>
                    <asp:ControlParameter ControlID="SearchDate" PropertyName="Text" Name="date" Type="DateTime"></asp:ControlParameter>
                </SelectParameters>
            </asp:ObjectDataSource>
